...
export const mockOccupancyData = {
  tables: {
    "table_1": { status: "free", confidence: 0.85 },
    "table_2": { status: "occupied", confidence: 0.92 },
    "table_3": { status: "free", confidence: 0.78 },
    "table_4": { status: "occupied", confidence: 0.88 },
    ...
    "table_9": { status: "free", confidence: 0.82 },
    "table_10": { status: "occupied", confidence: 0.94 },
    "table_11": { status: "free", confidence: 0.79 },
    "table_12": { status: "occupied", confidence: 0.90 },
